...
//ecshop add end 
$modules['04_order']['10_kuaidi_order']               = 'kuaidi_order.php?act=list';  //代码增加  By  www.68ecshop.com
$modules['04_order']['10_kuaidi_order2']             = 'kuaidi_order.php?act=list&order_status=4&is_finish=1';  //代码增加  By  www.68ecshop.com
