...
{
    $smarty->assign('ur_here',     $_LANG['postman_list']);
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('action_link',  array('href' => 'postman.php?act=list', 'text' => $_LANG['postman_list']));
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link', array('href' => 'postman.php?act=list&' . list_link_postfix(), 'text' => $_LANG['postman_list']));
