...
elseif ($_REQUEST['act']=='update')
{
  ...
  if(count($info)>0){
  	...
  	$db->query($sql);
	  	...
	  	$insql = "INSERT INTO `ecs_supplier_admin_user` (`uid`, `user_name`, `email`, `password`, `ec_salt`, `add_time`, `last_login`, `last_ip`, `action_list`, `nav_list`, `lang_type`, `agency_id`, `supplier_id`, `todolist`, `role_id`, `checked`) ".
