 ...
 * ============================================================================
 * $Author: ecshop120.com $
 * $Id: users_export.php 17217 2013-01-19 06:29:08Z ecshop120.com $
 */
...
elseif ($_REQUEST['act'] == 'act_export_excel')
{
	admin_priv('users_manage');
	 ...
	 $sql_ecshop120_com = "select * from ". $GLOBALS['ecs']->table('user_rank');
	 $res_ecshop120_com = $GLOBALS['db']->query($sql_ecshop120_com);
	 while ($row_ecshop120_com = $GLOBALS['db']-> fetchRow($res_ecshop120_com))
	 {
		 if ($row_ecshop120_com['special_rank'])
		 {
			$rank_list_www_com[$row_ecshop120_com['rank_id']] = $row_ecshop120_com['rank_name'];
		 }
		 else
		 {
			$rank_list_www_com[0][$row_ecshop120_com['rank_id']] = array(
																							'rank_name' => $row_ecshop120_com['rank_name'],
																							'min_points' => $row_ecshop120_com['min_points'],
																							'max_points' => $row_ecshop120_com['max_points']
																							);
		 }
	 }
