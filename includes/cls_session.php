...
class cls_session
{
    ...
    function insert_session()
    {
		...
		//return $this->db->query('INSERT INTO ' . $this->session_table . " (sesskey, expiry, ip, data) VALUES ('" . $this->session_id . "', '". $this->_time ."', '". $this->_ip ."', 'a:0:{}') on duplicate key update expiry='".$this->_time."'");
    }
