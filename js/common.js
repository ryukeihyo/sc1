 ...
 * @param $type
 */
function  changepay_type(type=''){
    if(type == '1'){  //支付宝
        document.getElementById("zhifubao").style.display='inline';
        document.getElementById("yinhangka").style.display='none';
        document.getElementById("sel_name").value="zhifubao";
    }else{  //银行卡
        document.getElementById("yinhangka").style.display='inline';
        document.getElementById("zhifubao").style.display='none';
        document.getElementById("sel_name").value="yinhangka";
    }
}