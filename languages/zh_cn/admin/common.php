...
$_LANG['02_supplier_goods_list'] = '供货商商品列表';
...
$_LANG['02_store_and_goods'] = '仓库库存管理';
$_LANG['01_store_manage']  = '仓库设置';
$_LANG['00_store_type']  = '仓库类型设置';
$_LANG['02_store_shipping_demo']  = '运费模板';
$_LANG['03_store_inout_goods']  = '出入库日志';
$_LANG['03_store_inout_in']  = '入库管理';
$_LANG['03_store_inout_out']  = '出库管理';
$_LANG['04_store_inout_stock']  = '即时库存查询';
$_LANG['15_store_out_type'] = '出库类型设置';
$_LANG['15_store_in_type'] = '入库类型设置';
...
$_LANG['02_supplier_order'] = '供货商订单列表';
/* 代码增加_end  By  supplier.68ecshop.com */
...
$_LANG['10_back_order'] = '退换货列表';   //代码修改  By  www.68ecshop.com
$_LANG['11_supplier_back_order'] = '供货商退换货列表';
$_LANG['10_kuaidi_order'] = '快递单列表';   //代码增加   By    www.68ecshop.com
$_LANG['10_kuaidi_order2'] = '快递单历史';   //代码增加   By    www.68ecshop.com
...
$_LANG['11_postman_list'] = '快递员列表';          //代码增加   By   www.68ecshop.com
...
$_LANG['cfg_desc']['company_type'] = '供货商申请时会用到，填写时注意每行一个企业类型';

$_LANG['supplier'] = '供货商管理';
$_LANG['supplier_manage'] = '供应商编辑与审核';
$_LANG['supplier_rank'] = '供应商等级';

$_LANG['cfg_name']['supplier_privilege'] = '供货商设置';
...
$_LANG['cfg_name']['supplier_notice'] = '供货商公告';
