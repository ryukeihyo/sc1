...
$_LANG['cfg_range']['stock_dec_time']['0'] = '发货自动扣除库存';
$_LANG['cfg_range']['stock_dec_time']['2'] = '人工出库扣除库存';
...
$_LANG['cfg_name']['comment_youxiaoqi'] = '订单评价/晒单有效期（单位月）';
...
$_LANG['cfg_name']['shaidan_pay_points'] = '晒单获得积分数量';
