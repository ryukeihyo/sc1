...
$_LANG['store_inout_add_in'] ='添加出库单';
$_LANG['store_inout_edit'] = '编辑出库单';
$_LANG['rec_id'] ='序号';
$_LANG['inout_sn_in'] = '出库单号';
$_LANG['store_name_in'] ='收货库房';
$_LANG['inout_type_in'] ='出库类型';
$_LANG['store_inout_list_in'] ='出库单列表';
$_LANG['no_article'] = '您现在还没有任何记录';
$_LANG['back_list_in'] ='返回出库列表';
$_LANG['add_time'] ='添加日期';
$_LANG['inoutadd_succeed_in'] ='出库单已经添加成功';
$_LANG['continue_add'] ='继续添加出库单';
$_LANG['order_sn'] ='关联订单号';
$_LANG['store_inout_check_in']='审核出库单';

$_LANG['inout_status']['1'] = '出库单录入中';
