...
//佣金管理部分权限
$_LANG['rebate_manage'] = '佣金列表未处理/已完结';
...
$_LANG['jxc_manage'] ='进销存管理'; 
$_LANG['store_manage'] = '仓库设置';
$_LANG['store_shipping_demo'] = '运费模板';
$_LANG['store_inout_goods'] = '出入库序时簿';
$_LANG['store_inout_stock'] = '即时库存查询';
$_LANG['store_inout_type'] = '出入库类型设置';
$_LANG['inout_in_manage'] = '入库管理';
$_LANG['inout_out_manage'] = '出库管理';
