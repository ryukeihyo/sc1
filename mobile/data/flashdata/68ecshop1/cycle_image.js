...
*/
document.write('<div id="flash_cycle_image" class="ghs_container"></div>');
var path = (document.getElementById('flash_path')) ? document.getElementById('flash_path').value : 'supplier';
$importjs = (function()
{
    var uid = 0;
    var curr = 0;
