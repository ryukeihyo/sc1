...
if($_GET['act']=='send'){
	...
	$target = "http://api.id98.cn/api/sms";
	...
	$post_data = "appkey=14f3cc432b17c980cfa51fb793bc92d2&templateid=1000&phone=$mobile&param=$mobile_code";
