...
if ($_REQUEST['act'] == 'get_inout_type')
{
	...
	$opt['target']=$target;
    $sql = "select type_id, type_name from ". $ecs->table('store_inout_type') ." where supplier_id in (-1,".$_REQUEST['storetypeid'].") and is_valid ='1' AND in_out= '$inout_mode' order by type_id asc ";
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('store_inout_list')."(inout_sn, store_id, inout_type, inout_mode, order_sn,  takegoods_man, ".
            ...
            "VALUES ('$inout_sn', '$_POST[sub_id]', '$_POST[inout_type]', '2', '$_POST[order_sn]', '$_POST[takegoods_man]', ".
                " '$today_sn', '$add_date', '$add_time', '$_SESSION[supplier_id]', '$_SESSION[storetypeid]')";
    $db->query($sql);
