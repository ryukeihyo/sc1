...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $is_only = $exc->is_only('type_name', $_POST['type_name'],0,"supplier_id=".$_SESSION['supplier_id']);
    ...
    $sql = "INSERT INTO ".$ecs->table('store_inout_type')."(type_name,  is_valid, in_out, supplier_id, store_type_id) ".
				"VALUES ('$_POST[type_name]',  '$is_valid' , '$in_out', '$_SESSION[supplier_id]', '$_REQUEST[storetypeid]')";
    $db->query($sql);
...
function get_typelist()
{
    ...
    if ($result === false)
    {
		...
		$where =" where supplier_id in (-1,".$_REQUEST['storetypeid'].") ";
