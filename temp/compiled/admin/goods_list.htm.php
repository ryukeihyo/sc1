...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><a href="javascript:listTable.sort('supplier_name'); ">供货商家</a><?php echo $this->_var['sort_supplier_name']; ?></th>
	<?php endif; ?>
...
?>
  <tr>
	...
	<?php if ($this->_var['suppliers_exists'] == 1): ?>
	<td align="center"><?php echo htmlspecialchars($this->_var['goods']['supplier_name']); ?></td>
	<?php endif; ?>
	...
	<td align="center"><?php if ($this->_var['goods']['supplier_id']): ?><?php if ($this->_var['goods']['supplier_status'] == '1'): ?>审核通过<?php elseif ($this->_var['goods']['supplier_status'] == '0'): ?>未审核<?php elseif ($this->_var['goods']['supplier_status'] == '-1'): ?>审核未通过<?php endif; ?><?php else: ?><?php endif; ?></td>
    ...
    <?php endif; ?>
    <td align="center"><a href="goods_tag.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank">标签</a></td> <!-- 晒单插件 增加 by www.68ecshop.com -->
    <td align="center">
