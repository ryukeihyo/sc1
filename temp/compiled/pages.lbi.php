...
?>
      ...
      <?php endif; ?>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <kbd style="float:left;position:relative;"><input type="text" name="page" onkeydown="if(event.keyCode==13)selectPage(this)" size="3" style=" height: 18px;padding:4px 0px;border: 1px solid #ddd;"/></kbd>
    </a>
    <?php endif; ?>
</div>
</div>
