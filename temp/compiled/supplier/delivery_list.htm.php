...
<a href="order.php?act=delivery_list&sid=0" <?php if ($this->_var['filter']['sid'] == '0'): ?>class="store_curr"<?php endif; ?>>全部</a>&nbsp;&nbsp;
...
?>
<a href="order.php?act=delivery_list&sid=<?php echo $this->_var['store']['store_id']; ?>" <?php if ($this->_var['filter']['sid'] == $this->_var['store']['store_id']): ?>class="store_curr"<?php endif; ?>><?php echo $this->_var['store']['store_name']; ?></a>&nbsp;&nbsp;
...
<td id="store_sub">
<a href="order.php?act=delivery_list&sid=<?php echo $this->_var['filter']['sid']; ?>&ssid=0"  <?php if ($this->_var['filter']['ssid'] == '0'): ?>class="store_curr"<?php endif; ?>>全部</a>&nbsp;&nbsp;
...
?>
<a href="order.php?act=delivery_list&sid=<?php echo $this->_var['filter']['sid']; ?>&ssid=<?php echo $this->_var['sub']['store_id']; ?>" <?php if ($this->_var['filter']['ssid'] == $this->_var['sub']['store_id']): ?>class="store_curr"<?php endif; ?> ><?php echo $this->_var['sub']['store_name']; ?></a>&nbsp;&nbsp;
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</td>
</tr>
<?php endif; ?>
