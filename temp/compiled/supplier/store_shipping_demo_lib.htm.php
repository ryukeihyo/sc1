...
?>
    <tr bgcolor=#ffffff> 
	 <td ><input type="checkbox" name="checkboxes[]" class="checkboxclass" value="<?php echo $this->_var['demo']['demo_id']; ?>" /><?php echo $this->_var['demo']['demo_id']; ?></td> 
     <!-- <td > <?php echo $this->_var['demo']['demo_name']; ?></td>  -->
	 <td > <?php echo $this->_var['demo']['shipping_name']; ?></td>
	 <!-- <td > <?php echo $this->_var['demo']['compute_mode_name']; ?></td> -->
	 <td > <?php echo $this->_var['demo']['fee_desc']; ?></td>
    </tr> 
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	</table> 
     <div class="blank15"></div>
	  <input type="hidden" value="shipping_area_fee_batch" name="act" >
	  <input type="hidden" value="<?php echo $this->_var['shipping_region_id']; ?>" name="shipping_region_id" >
