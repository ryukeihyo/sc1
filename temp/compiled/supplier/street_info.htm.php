...
?>
	  ...
	  <tr>
        ...
        <td><input type="text" name="supplier_desc" value="<?php echo $this->_var['sinfo']['supplier_desc']; ?>" maxlength="16">
		<font color="red">*</font> <span class="notice-span">为保证美观度,店铺描述控制在16个文字以内</span>
		</td>
      </tr>
	  <tr>
        <td class="label">店铺标签:</td>
        <td><input type="text" name="supplier_tags" value="<?php echo $this->_var['sinfo']['supplier_tags']; ?>" maxlength="2">
		<font color="red">*</font> <span class="notice-span">店铺标签控制在2个文字以内</span>
		</td>
      </tr>
	  ...
	  <tr>
		...
		<?php else: ?>
            ...
            <?php endif; ?>
        <?php endif; ?>
		<font color="red">*</font> <span class="notice-span">为达到前台图标显示最佳状态，建议上传220X220px图片</span>
		</td>
      </tr>
	  <tr>
