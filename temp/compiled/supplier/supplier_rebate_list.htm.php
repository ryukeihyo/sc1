...
?>
    <tr>
      <td class="first-cell" style="padding-left:10px;" ><?php echo $this->_var['supplier']['rebate_id']; ?></td>
      <td ><?php echo $this->_var['supplier']['rebate_paytime_start']; ?>---<?php echo $this->_var['supplier']['rebate_paytime_end']; ?> </td>
      <td align=right><?php echo $this->_var['supplier']['all_money_formated']; ?></td>
	  <td align="right"><?php echo $this->_var['supplier']['rebate_money_formated']; ?></td>
	  <td align="right"><?php echo $this->_var['supplier']['pay_money_formated']; ?></td>
	  <td align="center"><?php echo $this->_var['supplier']['pay_status']; ?></td>
	  <td align="center"><?php echo $this->_var['supplier']['pay_time']; ?></td>
	  <td align="center" width="25%"><?php echo $this->_var['supplier']['remark']; ?></td>
      <td align="center">
        <a href="supplier_rebate.php?act=view&is_pay_ok=<?php echo $_GET['is_pay_ok']; ?>&id=<?php echo $this->_var['supplier']['rebate_id']; ?>" title="查看此时间段内金额转帐信息">详情</a><br><a href="supplier_order.php?act=list&rebateid=<?php echo $this->_var['supplier']['rebate_id']; ?>" title="查看此时间段内订单"><?php echo $this->_var['lang']['view']; ?></a></td>
    </tr>
    <?php endforeach; else: ?>
    <tr><td class="no-records" colspan="15"><?php echo $this->_var['lang']['no_records']; ?></td></tr>
    <?php endif; unset($_from); ?><?php $this->pop_vars();; ?>
	<?php if ($this->_var['total_info']['all_money'] > 0 || $this->_var['total_info']['rebate_money'] > 0 || $this->_var['total_info']['pay_money'] > 0): ?>
	<tr>
	<td colspan=3 align=right>小计：&nbsp;&nbsp;<?php echo $this->_var['total_info']['all_money_formated']; ?></td>
	<td align=right><?php echo $this->_var['total_info']['rebate_money_formated']; ?></td>
	<td align=right><?php echo $this->_var['total_info']['pay_money_formated']; ?></td>
	<td colspan=9></td>
	</tr>
	<?php endif; ?>
  </table>
