...
<div id="license-div" style="bgcolor:#000000;"></div>
  <div id="license1-div" style="bgcolor:#000000;">
    ...
    <div id="submenu-div">
<ul>
<li class="show_4"><a href="index.php?act=clear_cache" target="main_frame" class="qinghc"><?php echo $this->_var['lang']['clear_cache']; ?></a> </li>
<li class="show_9"><a href="privilege.php?act=logout" target="_top"><?php echo $this->_var['lang']['signout']; ?></a></li>
<li class="show_1"><a href="../supplier.php?suppId=<?php echo $_SESSION['supplier_id']; ?>" target="_blank">查看店铺网站</a></li></ul></div>
    <?php if ($this->_var['send_mail_on'] == 'on'): ?>
...
<div id="menu-div">
  <ul>
    ...
    <li class="midd_22"><a href="index.php?act=main" target="main_frame"><?php echo $this->_var['lang']['admin_home']; ?></a></li>
    <li class="midd_23"><a href="privilege.php?act=modif" target="main_frame"><?php echo $this->_var['lang']['set_navigator']; ?></a></li>
