...
function get_comment_count( $id, $type, $flag = 0 )
{
        ...
        $sql = "SELECT COUNT(*) FROM ".$GLOBALS['ecs']->table( "comment" ).( " WHERE id_value = '".$id."' AND status = 1 AND parent_id = 0 " ).$where;
